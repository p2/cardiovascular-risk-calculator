...
var localizations = {
	...
	'en': {
		...
		'_html_localization': [
			...
			{'id': 'RussianContribution', 'value':'The Russian translation of this tool was made possible by neurologist Michael Jablonski (Balashikha) and cardiologist PhD Denis Sinkevich (Irkutsk).'},
			{'id': '5years', 'value': '5 years'},
			{'id': 'PREDICT_Endpoints', 'value': 'Heart attacks + angina + heart failure + strokes/TIAs + peripheral vascular disease'},
			{'id': 'USData', 'value': 'US Data'},
			{'id': 'UKData', 'value': 'UK Data'},
			{'id': 'NZData', 'value': 'New Zealand Data'},
			{'id': 'European', 'value': 'European'},
			{'id': 'Indian', 'value': 'Indian'},
			{'id': 'NewZealand', 'value': 'New Zealand'},
			{'id': 'Pacific', 'value': 'Pacific'},
			{'id': 'ChineseOtherAsian', 'value': 'Chinese/Other Asian'},
			{'id': 'CurrentSmoker', 'value': 'Current Smoker'},
			{'id': 'OnLipidLoweringTreatment', 'value': 'On lipid-lowering treatment'},
			{'id': 'ClickYesForLipidTx', 'value': 'Click YES if taking lipid-lowering medication'},
			{'id': 'OnAntithrombotic', 'value': 'On antithrombotic treatment'},
			{'id': 'ClickYesForAntithrombotic', 'value': 'Click YES if taking antiplatelet/anticoagulant medication'},
			{'id': 'PREDICT_CKD', 'value': 'The PREDICT paper excluded patients with chronic kidney disease. Risk estimated produced by PREDICT in this patient population are not validated.'},
			{'id': 'DeprivationQuintile', 'value': 'Deprivation Quintile'},
			{'id': 'NoDeprivation', 'value': '1 - No deprivation characteristics'},
			{'id': 'SignificantDeprivation', 'value': '5 - Significant socioeconomic deprivation'},
			{'id': 'DeprivationDescription', 'value': 'This socioeconomic deprivation index can be determined by answering eight questions. For detailed information, see page two of the (NZDep2013 brief flyer) or (visit the website).'},
			{'id': 'YearRisk', 'value': 'Year Risk'}
		]
	},
	...
	'fr': {
		...
		'_html_localization': [
			...
			{'id': 'RussianContribution', 'value':'La traduction russe de cet outil a été rendue possible par le neurologiste Michael Jablonski (Balashikha) et le cardiologue Ph.D Denis Sinkevich (Irkoutsk).'},
			...
			{'id': '5years', 'value': '5 années'},
			{'id': 'PREDICT_Endpoints', 'value': 'Crises cardiaques + angine de poitrine + insuffisance cardiaque + AVC / AIT + maladie vasculaire périphérique'},
			{'id': 'USData', 'value': 'Données américaines'},
			{'id': 'UKData', 'value': 'Données britanniques'},
			{'id': 'NZData', 'value': 'Données de la Nouvelle-Zélande'},
			{'id': 'European', 'value': 'Européen'},
			{'id': 'Indian', 'value': 'Indien'},
			{'id': 'NewZealand', 'value': 'Nouvelle-Zélande'},
			{'id': 'Pacific', 'value': 'Pacifique'},
			{'id': 'ChineseOtherAsian', 'value': 'Chinois / Autres asiatiques'},
			{'id': 'CurrentSmoker', 'value': 'Fumeur actuel'},
			{'id': 'OnLipidLoweringTreatment', 'value': 'Sous traitement hypolipémiant'},
			{'id': 'ClickYesForLipidTx', 'value': 'Cliquez OUI si vous prenez un médicament hypolipémiant'},
			{'id': 'OnAntithrombotic', 'value': 'Sous traitement antithrombotique'},
			{'id': 'ClickYesForAntithrombotic', 'value': 'Cliquez OUI si vous prenez des médicaments antiplaquettaires/ anticoagulants'},
			{'id': 'PREDICT_CKD', 'value': 'L’étude PREDICT excluait les patients atteints d\'insuffisance rénale chronique. Les risques estimés par PREDICT pour cette population de patients ne sont pas validés.'},
			{'id': 'DeprivationQuintile', 'value': 'Quintile de défavorisation'},
			{'id': 'NoDeprivation', 'value': '1 - Aucune caractéristique de défavorisation'},
			{'id': 'SignificantDeprivation', 'value': '5 - Défavorisation socio-économique significative'},
			{'id': 'DeprivationDescription', 'value': 'Cet indice de défavorisation socio-économique peut être déterminé en répondant à huit questions. Pour plus d\'informations, consultez la page deux du dépliant (NZDep2013) ou (visitez le site Web).'},
			{'id': 'YearRisk', 'value': 'Années Risque'}
		]
	},
	...
	'ru': {
		...
		'_html_localization': [
			...
			{'id': '5years', 'value': '5 лет'},
			{'id': 'PREDICT_Endpoints', 'value': 'todo'},
			{'id': 'USData', 'value': 'todo'},
			{'id': 'UKData', 'value': 'todo'},
			{'id': 'NZData', 'value': 'todo'},
			{'id': 'European', 'value': 'todo'},
			{'id': 'Indian', 'value': 'todo'},
			{'id': 'NewZealand', 'value': 'todo'},
			{'id': 'Pacific', 'value': 'todo'},
			{'id': 'ChineseOtherAsian', 'value': 'todo'},
			{'id': 'CurrentSmoker', 'value': 'todo'},
			{'id': 'OnLipidLoweringTreatment', 'value': 'todo'},
			{'id': 'ClickYesForLipidTx', 'value': 'todo'},
			{'id': 'OnAntithrombotic', 'value': 'todo'},
			{'id': 'ClickYesForAntithrombotic', 'value': 'todo'},
			{'id': 'PREDICT_CKD', 'value': 'todo'},
			{'id': 'DeprivationQuintile', 'value': 'todo'},
			{'id': 'NoDeprivation', 'value': 'todo'},
			{'id': 'SignificantDeprivation', 'value': 'todo'},
			{'id': 'DeprivationDescription', 'value': 'todo'},
			{'id': 'YearRisk', 'value': 'todo'}
		]
	}
